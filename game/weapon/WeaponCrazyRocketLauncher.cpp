...
class rvWeaponCrazyRocketLauncher : public rvWeapon {
public:

	CLASS_PROTOTYPE( rvWeaponCrazyRocketLauncher );

	rvWeaponCrazyRocketLauncher ( void );
	~rvWeaponCrazyRocketLauncher ( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( rvWeaponCrazyRocketLauncher );
};

CLASS_DECLARATION( rvWeapon, rvWeaponCrazyRocketLauncher )
END_CLASS

/*
================
rvWeaponCrazyRocketLauncher::rvWeaponCrazyRocketLauncher
================
*/
rvWeaponCrazyRocketLauncher::rvWeaponCrazyRocketLauncher ( void ) {
}
...
/*
================
rvWeaponCrazyRocketLauncher::Spawn
================
*/
void rvWeaponCrazyRocketLauncher::Spawn ( void ) {
	float f;
...
/*
================
rvWeaponCrazyRocketLauncher::Think
================
*/
void rvWeaponCrazyRocketLauncher::Think ( void ) {	
	trace_t	tr;
	int		i;
...
/*
================
rvWeaponCrazyRocketLauncher::OnLaunchProjectile
================
*/
void rvWeaponCrazyRocketLauncher::OnLaunchProjectile ( idProjectile* proj ) {
...
/*
================
rvWeaponCrazyRocketLauncher::SetRocketState
================
*/
void rvWeaponCrazyRocketLauncher::SetRocketState ( const char* state, int blendFrames ) {
	rocketThread.SetState ( state, blendFrames );
}

/*
=====================
rvWeaponCrazyRocketLauncher::Save
=====================
*/
void rvWeaponCrazyRocketLauncher::Save( idSaveGame *saveFile ) const {
...
/*
=====================
rvWeaponCrazyRocketLauncher::Restore
=====================
*/
void rvWeaponCrazyRocketLauncher::Restore( idRestoreGame *saveFile ) {
	int numEnts = 0;
	idEntity* ent = NULL;
...
/*
================
rvWeaponCrazyRocketLauncher::PreSave
================
*/
void rvWeaponCrazyRocketLauncher::PreSave ( void ) {
}

/*
================
rvWeaponCrazyRocketLauncher::PostSave
================
*/
void rvWeaponCrazyRocketLauncher::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( rvWeaponCrazyRocketLauncher )
	STATE ( "Idle",				rvWeaponCrazyRocketLauncher::State_Idle)
	STATE ( "Fire",				rvWeaponCrazyRocketLauncher::State_Fire )
	STATE ( "Raise",			rvWeaponCrazyRocketLauncher::State_Raise )
	STATE ( "Lower",			rvWeaponCrazyRocketLauncher::State_Lower )

	STATE ( "Rocket_Idle",		rvWeaponCrazyRocketLauncher::State_Rocket_Idle )
	STATE ( "Rocket_Reload",	rvWeaponCrazyRocketLauncher::State_Rocket_Reload )
	
	STATE ( "AddToClip",		rvWeaponCrazyRocketLauncher::Frame_AddToClip )
END_CLASS_STATES


/*
================
rvWeaponCrazyRocketLauncher::State_Raise

Raise the weapon
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Raise ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
rvWeaponCrazyRocketLauncher::State_Lower

Lower the weapon
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Lower ( const stateParms_t& parms ) {	
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITRAISE
...
/*
================
rvWeaponCrazyRocketLauncher::State_Idle
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
rvWeaponCrazyRocketLauncher::State_Fire
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Fire ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
rvWeaponCrazyRocketLauncher::State_Rocket_Idle
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Rocket_Idle ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
		STAGE_WAITEMPTY,
...
/*
================
rvWeaponCrazyRocketLauncher::State_Rocket_Reload
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::State_Rocket_Reload ( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
rvWeaponCrazyRocketLauncher::Frame_AddToClip
================
*/
stateResult_t rvWeaponCrazyRocketLauncher::Frame_AddToClip ( const stateParms_t& parms ) {
	AddToClip ( 1 );
	return SRESULT_OK;
}
